...
if ($theuser)
    ...
    <nav class="navbar navbar-inverse yeni">
        <div class="container-fluid">
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <button><li><a href="form.php"><span class="glyphicon glyphicon-user">login</span></a></li></button>

                <li><a href="."><span class="glyphicon glyphicon-log-in">kayit ol</span></a></li>
            </ul>
        </div>
    </nav>
    <br>
    ...
    <a href="." class="giris" style="position: relative; left: 620px;">log in</a>
    <a href="." class="giris" style="position: relative; left: 630px;">join for free</a>
    <br> -->
    <br>
    ...
    <!-- <div class="r">
        ...
        <img src="resim3.jpg" alt="resim" style="height: 400px; margin-left: 0;">

    </div>
    <div class="r">
        <h2>WATCH ALL MOVİES</h2>
        <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Labore nemo quisquam odit. Est velit, labore soluta
            reiciendis quaerat corrupti voluptatibus, qui, provident ipsum sequi inventore laboriosam corporis molestiae
            id cupiditate!</p>
        <br>
        <a href="https://www.sinemalar.com/filmler" target="_blank" rel="noopener noreferrer">Wiew features</a>
    </div>
</s> -->
    <br>
    <br>
