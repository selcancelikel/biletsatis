...
$ek = "INSERT INTO bilet (name, konser, adet) VALUES ('$isim', 'yasliamca', $adet)";
...
<div class="container">
        <div class="row">
            ...
            <div class="col-lg-4 mb-lg-0 mb-3">
                <div class="card p-3">
                    <div class="img-box">
                        <img src="mastercard.png" style="width:100%; height:100%; object-fit: cover;"
                            alt="">
                    </div>
                    <div class="number">
                            ...
                            <div class="row">
                                <div class="col-8">
                                    ...
                                    <p class="mb-0"><span class="fw-bold">Price:</span><span
                                            class="c-green"><?php echo "tl: " . $tutar;  ?></span></p>
                            ...
                            <div class="row">
                                <div class="col-lg-5 mb-lg-0 mb-3">
                                    ...
                                    <p class="mb-0">
                                        ...
                                        <span class="c-green"><?php echo "tl: " . $tutar;  ?></span>
                                    </p>
                                    <p class="mb-0">Lorem ipsum, dolor sit amet consectetur adipisicing elit. Atque
                                        nihil neque
                                        quisquam aut
                                ...
                                <div class="col-lg-7">
                                    <form action="payment.php" class="form" method:"post">
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                <div class="btn btn-primary w-100">Ode</div>
                                            </div>
                                        </div>
                                    </form>
                                </div>
    ...
    <button class="btn info"><a href="index.php"><h3>Anasayfaya donebilirsiniz<h3></a><button>
